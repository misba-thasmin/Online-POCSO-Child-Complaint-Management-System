...
const AdvocateRegister = () => {
    ...
    useEffect(() => {
        const fetchExistingEmails = async () => {
            try {
                const response = await axios.get('http://localhost:4000/api/v1/advocate/');
    ...
    const handleActualSubmit = async () => {
        try {
            ...
            if (response.ok) {
                alert('Advocate Account Registered Successfully! Please Login.');
                window.location.href = "/advocate_login";
            } else {
                        ...
                        <div className="card border-0 shadow-lg rounded-4 overflow-hidden" style={{ backgroundColor: '#ffffff' }}>
                            <div className="card-body p-sm-5 p-4">
                                ...
                                <div className="text-center mb-5 border-bottom pb-4">
                                    <div className="d-inline-flex justify-content-center align-items-center text-primary rounded-circle mb-3" style={{ width: '50px', height: '50px', backgroundColor: 'rgba(59,130,246,0.1)' }}>
                                        <i className="fa fa-balance-scale fa-lg"></i>
                                    </div>
                                    <h3 className="fw-bold text-dark mb-1">Advocate Registration</h3>
                                    <p className="text-muted small mb-0">Join the legal network to manage and assist with cases.</p>
                                </div>
                                ...
                                <form onSubmit={handleSubmit}>
                                    <div className="row g-4">
                                        <div className="col-md-6">
                                            ...
                                            <div className="input-group">
                                                ...
                                                <input type="text" name="name" className="form-control bg-light border-start-0 ps-0 form-control-lg" style={{ fontSize: '15px' }} value={userData.name} onChange={handleChange} placeholder="Advocate Name" required />
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-md-6">
                                            ...
                                            <div className="input-group">
                                                ...
                                                <input type="email" name="email" className={`form-control bg-light border-start-0 ps-0 form-control-lg ${validationErrors.email ? 'is-invalid' : ''}`} style={{ fontSize: '15px' }} value={userData.email} onChange={handleChange} placeholder="advocate@legal.net" required />
                                            </div>
                                        ...
                                        <div className="col-md-6">
                                            ...
                                            {validationErrors.passwordHash ? (
                                                ...
                                                <div className="form-text small text-muted"><i className="fa fa-info-circle"></i> Min 8 chars, 1 uppercase, 1 symbol, 1 digit.</div>
                                            )}
                                        </div>
                                        ...
                                        <div className="col-12">
                                            <label className="form-label fw-semibold text-secondary small mb-1">Practicing City</label>
                                            <div className="input-group">
                                                <span className="input-group-text bg-light border-end-0 text-muted"><i className="fa fa-map-marker"></i></span>
                                                <input type="text" name="city" className="form-control bg-light border-start-0 ps-0 form-control-lg" style={{ fontSize: '15px' }} value={userData.city} onChange={handleChange} placeholder="Enter your primary practicing city" required />
                                            </div>
                                        </div>

                                        <div className="col-12 mt-4 border-top pt-4">
                                            <h6 className="fw-bold mb-3 text-dark"><i className="fa fa-shield text-primary me-2"></i> Security Recovery Questions</h6>
                                        </div>
                                    ...
                                    <div className="mt-5">
                                        <button type="submit" className="btn btn-primary btn-lg w-100 hover-lift shadow-sm" style={{ borderRadius: '12px', fontWeight: 'bold', padding: '14px' }}>
                                            <i className="fa fa-user-plus me-2"></i> Create Advocate Account
                                        </button>
                                    </div>
                                </form>
                                ...
                                <div className="text-center mt-4">
                                    <span className="text-muted small">
                                        Already have an account? <Link to="/advocate_auth" className="text-primary fw-bold text-decoration-none ms-1">Sign In</Link>
                                    </span>
                                </div>
                            </div>
                        </div>
